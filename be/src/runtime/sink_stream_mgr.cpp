...
Status SinkStreamHandler::_create_and_open_file(TargetSegmentPtr target_segment, std::string path, bool is_last) {
    LOG(INFO) << "create and open file, path = " << path << ", is_last = " << is_last;
    if (is_last) {
