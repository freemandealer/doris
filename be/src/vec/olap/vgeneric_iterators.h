...
public:
    VMergeIteratorContext(RowwiseIterator* iter, int sequence_id_idx, bool is_unique,
        ...
        LOG(WARNING) << "OOXXOO read_orderby_key_columns" << read_orderby_key_columns;
        LOG(WARNING) << "OOXXOO _sequence_id_idx" << _sequence_id_idx;
        LOG(WARNING) << "OOXXOO _is_unique" << _is_unique;
        LOG(WARNING) << "OOXXOO _is_reverse" << _is_reverse;
        LOG(WARNING) << "OOXXOO _num_columns" << _num_columns;
        LOG(WARNING) << "OOXXOO _num_key_columns" << _num_key_columns;
    }
